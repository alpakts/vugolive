...
const VideoPlayer = (props) => {
  ...
  return (
    ...
    >
      <div className="h-screen w-screen flex justify-center items-center px-4 relative">
        <div onClick={closeModal} className="absolute right-4 top-5">
        ...
        <div className="video-container relative">
          ...
          <div
            className={`controls absolute w-full bottom-2 px-2 bg-secondary bg-opacity-50 h-5 ${
