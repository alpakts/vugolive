...
import { GetPosts, getUserProfile, LikePostById, ListOwnPosts } from "@/lib/services/api-service";
...
export default function Page() {
 ...
 const sayHiToUser = async (sender, receiverId) => {
  ...
  return (
   ...
   <SlidingModal OpenButton={ <button className="bg-primary transition-all text-black px-4 py-2 rounded-lg hover:bg-gray-900 hover:text-white">Anı Paylaş</button>}><AddPostForm></AddPostForm></SlidingModal>
   </div>
